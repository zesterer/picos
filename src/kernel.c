...
enum
{
	...
	//Controls actuation of pull up/down of specific GPIO pin
...
void uart_init()
{
	...
	//Disable pull up/down for GPIO pins & delay for 150 cycles
...
#if defined(__cplusplus)
	extern "C" //Use C linking for kernel_main
#endif
...
void kernel_main(uint32_t r0, uint32_t r1, uint32_t atags)
{
	...
	uart_puts("Hello, World, from the kernel!\r\n");
